<template>
  <div class="signup">
    ...
    <table>
      ...
      <template v-if="!flag">
        <button @click="login" class="button is-primary" >ログイン</button>
        <p @click="toggleFlag" class="button is-info">新規登録はこちらから</p>
      </template>
      <template v-else>
        <button @click="signs" class="button is-primary" >新規登録</button>
        <p @click="toggleFlag"  class="button is-info">ログインはこちらから</p>
      </template>
  </div>
</template>
